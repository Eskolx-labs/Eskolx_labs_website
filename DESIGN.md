...
- **Mobile gets its cover art**: the seal flood scrubs at every size (the pinned room joins the mobile pin tier at 180vh; the seal floods to scale 16 and releases past 19), typing runs at every width, and the header always offers Telegram; the GitHub pill joins from `sm`.
